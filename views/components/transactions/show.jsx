...
import { Badge, Button, Descriptions, Flex, Table } from "antd";
...
const columns = [
    { title: 'Quantité', dataIndex: 'qté' },
    { title: "Objet", dataIndex: 'objet' },
    { title: 'Agence', dataIndex: 'agence_ref' },
    { title: 'Materiel', dataIndex: 'materiel_ref' },
    ...
    useEffect(() => {
        const fechdata = async () => {
            try {
                ...
                const fetch = await window.fetch(`${url}/transaction/show`, {
                    headers: headersHttp,
                    method: "GET",
                    mode: "cors"
                })
